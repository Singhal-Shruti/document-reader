...
from journey_app.config import SOURCE_CONFLUENCE, require_env_var
...
def _ensure_source_metadata(
    ...
    for doc in documents:
        doc.metadata.setdefault("source_type", SOURCE_CONFLUENCE)
...
def load_confluence(
    *,
    ...
    Credentials are read from ``CONFLUENCE_URL``, ``CONFLUENCE_USERNAME``
